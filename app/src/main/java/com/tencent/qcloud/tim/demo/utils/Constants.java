...
public class Constants {
    ...
    public static final int SDKAPPID = 1400197389; // 替换成您在腾讯云控制台云通信的应用SDKAPPID，链接 https://console.cloud.tencent.com/avc
    ...
    public static final long HW_PUSH_BUZID = 6684;
    // 华为开发者联盟给应用分配的应用APPID
    public static final String HW_PUSH_APPID = "100795445"; // 见清单文件
    /****** 华为离线推送参数end ******/
