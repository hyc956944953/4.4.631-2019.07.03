...
public class GenerateTestUserSig {
    ...
    private static final String PRIVATEKEY = "-----BEGIN PRIVATE KEY-----\n" +
            "MIGHAgEAMBMGByqGSM49AgEGCCqGSM49AwEHBG0wawIBAQQgNgE1xepw6PnglGXy\n" +
            "W135FR0A3+1l6x7MXDdDzdo/6O+hRANCAAS3eyRkcgZyl9l59D1AkLIiX1oaNRdh\n" +
            "lHjtiwowdJg1CB7WovJAVjTTiZikxAvZWJSc9JB4NRfKnduuBa0eh3VT\n" +
            "-----END PRIVATE KEY-----\n";
